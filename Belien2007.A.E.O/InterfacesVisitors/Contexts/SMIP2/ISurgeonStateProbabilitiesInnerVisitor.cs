namespace Belien2007.A.E.O.InterfacesVisitors.Contexts.SMIP2
{
    ...
    public interface ISurgeonStateProbabilitiesInnerVisitor<TKey, TValue> : IVisitor<KeyValuePair<TKey, TValue>>
        where TKey : INullableValue<int>
        where TValue : INullableValue<decimal>
    {
        RedBlackTree<IkIndexElement, IhParameterElement> RedBlackTree { get; }
    }
}